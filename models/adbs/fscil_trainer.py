        ...
        for session in range(args.start_session, args.sessions):
            ...
            if session == 0:  # load base class train img label
                ...
                for epoch in range(args.epochs_base):
                    ...
                    # train base sess
                    tl, tl_cls, ta, tl_reg = base_train(self.model, trainloader, optimizer, scheduler, epoch, args)
                    ...
                    result_list.append(
'epoch:%03d,lr:%.4f,training_loss:%.5f,cls_loss:%.5f,reg_loss:%.5f,training_acc:%.5f,test_loss:%.5f,test_acc:%.5f'% (epoch, lrc, tl, tl_cls, tl_reg, ta, tsl, tsa))
                ...
                train_set.multi_train = True
                new_train(trainloader, self.model, session, args)
    ...
    def set_save_path(self):
        ...
        # Add custom path
        if self.args.save_path_flag:
            self.args.save_path = os.path.join(self.args.save_path, self.args.save_path_flag)
