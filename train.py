...
def get_command_line_parser():
    ...
    parser.add_argument('-fantasy', type=str, default='no_transform')
    ...
    # for ADBS
    parser.add_argument('-epochs_new_train', type=int, default=10)
    parser.add_argument('-gamma2', type=float, default=0.1)
    parser.add_argument('-milestones2', nargs='+', type=int, default=[100])
    parser.add_argument('-save_path_flag', type=str, default=None)
